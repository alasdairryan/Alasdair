...
namespace OpenTk
{
    ...
    {
        public OpenTKWindow() : base(1000, 800, new GraphicsMode(32, 24, 0, 4))
        {
        ...
        void initProgram()
        {
            ...
            loadShader(@"C:\Users\ryana2\Documents\Visual Studio 2015\Projects\OpenTk\OpenTk\Vertex.txt", ShaderType.VertexShader, pgmID, out vsID);
            loadShader(@"C:\Users\ryana2\Documents\Visual Studio 2015\Projects\OpenTk\OpenTk\Frag.txt", ShaderType.FragmentShader, pgmID, out fsID);
